...
void main() {
  ...
  testWidgets('checking the text reschedule...', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(home: LinkActivity2()));
    await tester.pump();

     expect(find.text("Reschedule Sent!"), findsOneWidget); 
  });
...
testWidgets('checking the text notification ...', (WidgetTester tester) async {
  ...
  testWidgets('checking the text got it inside the button ...', (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(home: LinkActivity2()));
    await tester.pump();
